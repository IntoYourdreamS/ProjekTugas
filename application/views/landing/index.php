...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>csss/bootstrap.min.css" >
    <!-- Icon -->
    ...
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>csss/owl.theme.css">
    
    <!-- Animate -->
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>csss/animate.css">
    <!-- Main Style -->
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>csss/main.css">
    <!-- Responsive Style -->
